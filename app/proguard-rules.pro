...
-keep public enum com.buSmptech.glide.load.ImageHeaderParser$** {
  **[] $VALUES;
  public *;
}
...
##---------------Start: proguard configuration for Room  ----------
...
-keep class com.prodan.currency.data.models.** { *; }
-keep class com.prodan.currency.domain.models.** { *; }
